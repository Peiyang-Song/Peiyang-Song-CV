...
%         \item Integrated the progress prediction model as a reward signal into greedy and RL search, enabling improved performance on the proof generation task.
%     \end{itemize}
% \end{itemize}
...
\cvitem{Preprint}{\textbf{LeanProgress: Guiding Search for Neural Theorem Proving
...
\cvitem{}{International Conference on Machine Learning (ICML)}
