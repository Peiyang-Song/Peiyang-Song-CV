...
%     \end{itemize}
%     \vspace{1em}
%     \item Project 2: \textbf{A Survey of LLM Reasoning Failures} (Lead, Wrapping Up).
%     \vspace{0.5em}
%     \begin{itemize}
...
%     \end{itemize}
%     \vspace{1em}
%     \item Project 3: \textbf{LeanAnalyst: Improving Formal Theorem Proving in Lean with Vertical Information about Proof Progress} (Co-Lead, Wrapping Up).
%     \vspace{0.5em}
%     \begin{itemize}
%         \item Constructed the \textbf{first} large-scale dataset of Lean proof search trees; created the \textbf{first} proof progress prediction model for theorem proving in Lean to guide development.
%         \item Built the \textbf{first} remaining-step-prediction tool \textbf{natively} in Lean to aid proof development.
%         \item Integrated the progress prediction model as a rewarad signal into greedy and RL search, enabling improved performance on the proof generation task.
%     \end{itemize}
% \end{itemize}
...
%         \item Published and \textbf{oral}-presented results at \textbf{ASPLOS 2024}.
%     \end{itemize}
%     \vspace{1em}
