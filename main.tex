...
\cvitem{}{\textit{IEEE Micro, 2025}, \textbf{Top Picks} From the 2024 Computer Architecture Conferences}
...
\cvitem{}{\textbf{1.1k+} stars on Github, ranking \textbf{2nd} after Mathlib4 among \textbf{all} Lean projects}
